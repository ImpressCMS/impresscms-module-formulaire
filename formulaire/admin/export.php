...
if (!empty($id) && empty($op)) {
	...
	$fp = fopen ("../../../uploads/formulaire/form.csv", "w") or die ("Can not write the file in the upload folder.");

	$msg = 'Formular;Abfrage;Titel;;;;Wert
';
...
';
	...
	fwrite ($fp, $msg) or die("Can not write file.");
